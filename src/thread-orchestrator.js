 ...
 *   "create a thread for the PR review, check Slack and hivemind for Matilda's ones"
 *   "start a thread to review ENG-895"
 *   "open a research thread on DStorm proxies"
 *
 * Flow:
...
export function parseOrchestrationCommand(text) {
  ...
  // Person hint: "Matilda's ones", "Lance's PRs", "from Junho"
  let personHint = null;
